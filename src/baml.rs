...
use crate::tools::{ToolMetadata, ToolRegistry as ConcreteToolRegistry};
...
impl BamlRuntimeManager {
    ...
    pub async fn invoke_function(
        ...
        executor
            .execute_function(function_name, args, tool_registry, interceptor_registry)
            .await
    }
    ...
    pub async fn register_llm_interceptor<I: crate::interceptor::LLMInterceptor>(
        &self,
        interceptor: I,
    ) {
    ...
    pub async fn register_tool_interceptor<I: crate::interceptor::ToolInterceptor>(
        &self,
        interceptor: I,
    ) {
        let mut registry = self.interceptor_registry.lock().await;
    ...
    pub fn map_baml_variant_to_tool(
        ...
        self.tool_mapper
            .register_mapping(baml_variant_name, tool_function_name);
    }
    ...
    pub async fn execute_tool_from_baml_result(&self, baml_result: Value) -> Result<Value> {
        ...
        let (variant_name, tool_args_value) =
            self.tool_mapper.parse_variant_and_args(&baml_result)?;
